 ...
 *     passive?: bool, // Global default for whether included components should cause hard failures // Default: false
 *     stealth?: bool, // Global default for whether included components issue verbose or stealthy error messages // Default: false
 *     enabled?: bool, // Allows you to globally disable all bundle functions, specifically for functional testing // Default: true
 *     profiles?: array<string, array{ // Name the profile // Default: []
 *         stealth?: bool, // Defines whether measures in this profile issue stealthy error messages // Default: true
 *         passive?: bool|null, // Passive mode will not make any of the included checks actually fail validation, they will still be logged. Null inherits global setting // Default: null
 *         banned_markup?: array{ // Defines whether to disallow content resembling markup languages like HTML and BBCode
 *             html?: bool, // Default: true
 *             bbcode?: bool, // Default: true
 *         },
 *         banned_phrases?: array{ // Simple array of phrases which are rejected when encountered in a submitted text field
 *             phrases?: list<scalar|null>,
 *         },
 *         banned_scripts?: array{ // Banned script types, like Cyrillic or Arabic (see docs for commonly used ISO 15924 names)
 *             scripts?: list<scalar|null>,
 *             max_characters?: int, // Default: null
 *             max_percentage?: float, // Default: 0
 *         },
 *         honeypot?: string|array{ // Inject an invisible honeypot field in forms, baiting spambots to fill it in
 *             field: scalar|null, // Base name of the injected field
 ...
 *             field?: scalar|null, // Base name of the injected field // Default: "_validation"
 *             min?: float, // Default: 3
 *             max?: float, // Default: 3600
 *         },
 *         url_count?: array{ // Configure limits to number of URLs permitted in text fields
 *             max?: int, // Maximum number of URLs accepted per text field // Default: null
 *             max_identical?: int, // Maximum number of identical URLs accepted per text field // Default: null
 *         },
 *     }>,
 * }
